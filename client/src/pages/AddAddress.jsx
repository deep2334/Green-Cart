...
const  InputField = ({type,placeholder,name,handleChange,address})=>(
  ...
  <input className="w-full px-2 pt-2.5 border border-gray-500/30 rounded outline-none text-grey-500 focus:border-primary transition"  
  type={type }
        ...
        <p className='text-2xl md:text-3xl text-gray-500'>Add shipping <span 
            ...
            <div className='flex flex-col-reverse md:flex-row justify-between mt-10 '>
                <div className='flex-1 max-w-md'>
                    ...
                    <button className='w-full bg-primary mt-6 text-white py-3 hover:bg-primary-dull transition cursor-pointer uppercase' 
